...
<body>
  ...
  <main>
    ...
    <?php
    {
     ...
     <img src='assets/google.jpg' class='google-logo'></a>
                 <span class='sign-in-text'><a href='" . $client->createAuthUrl() . "' style='text-decoration: none;color: black;'>Sign-in with Google</a></span>
        </div>
        </section>";
        }
    ?>
